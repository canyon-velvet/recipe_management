...
- **Collect recipes in one place.** Paste in a recipe from anywhere, then note where it came
  from. Search by name or browse by category.
...
- **Get the grocery list for free.** Ingredients from the week's meals are gathered into one
  list, grouped by the store where I buy them (the Chinese supermarket or the regular one).
- **Skip what I already have.** Mark items I already have at home, and they stay marked
  even when the meal plan changes.

## What's next

Right now recipes are added by copy and paste. Next, I plan to support **pasting a link** to a
recipe website or social media post and having the recipe filled in automatically.
